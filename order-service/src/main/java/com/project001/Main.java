...
public class Main {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/uushop?serverTimezone=UTC");
        ...
        //扫描路径
        globalConfig.setOutputDir(System.getProperty("user.dir")+"/order-com.project001.service/src/main/java");
        ...
        //修改成数据库要使用的表order_master,order_detail
